...
![Search Directory example](https://github.com/PatrickF1/fzf.fish/raw/assets/directory.png)
...
![Search Git Log example](https://github.com/PatrickF1/fzf.fish/raw/assets/git_log.png)
...
![Search Git Status example](https://github.com/PatrickF1/fzf.fish/raw/assets/git_status.png)
...
![Search History example](https://github.com/PatrickF1/fzf.fish/raw/assets/history.png)
...
![Search Processes example](https://github.com/PatrickF1/fzf.fish/raw/assets/processes.png)
...
![Search Variables example](https://github.com/PatrickF1/fzf.fish/raw/assets/variables.png)
...
| [fzf][]  | 0.60.0                   | fuzzy finder that powers this plugin    |
...
To pipe the git diff previews from [Search Git Log][] and [Search Git Status][] through a highlighter tool (e.g. [delta](https://github.com/dandavison/delta) or [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy)), set a command invoking the highlighter in `fzf_diff_highlighter`:
