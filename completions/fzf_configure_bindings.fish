...
complete fzf_configure_bindings --long=git-log --description="Change the key binding for Search Git Log" --condition="not __fish_seen_argument --git-log"
complete fzf_configure_bindings --long=git-status --description="Change the key binding for Search Git Status" --condition="not __fish_seen_argument --git-status"
