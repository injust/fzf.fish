...
bind --mode=insert ctrl-a >/dev/null; and bind --mode=insert ctrl-e >/dev/null
...
binding_contains_func ctrl-alt-l _fzf_search_git_log; and binding_contains_func ctrl-r _fzf_search_history; and binding_contains_func ctrl-v $_fzf_search_vars_command
